      ...
      <div className="subjects-section" style={{ marginTop: '2rem' }}>
        <h3>Your Subjects</h3>
          <div className="subject-bubbles-container">
            <div className="subject-bubble glass-panel math" onClick={() => navigate('/courses')}>
              <span className="subject-icon">➕</span>
              <h4>Math</h4>
            </div>
            <div className="subject-bubble glass-panel science" onClick={() => navigate('/courses')}>
              <span className="subject-icon">🧪</span>
              <h4>Science</h4>
            </div>
            <div className="subject-bubble glass-panel english" onClick={() => navigate('/courses')}>
              <span className="subject-icon">🔤</span>
              <h4>English</h4>
            </div>
            <div className="subject-bubble glass-panel ict" onClick={() => navigate('/courses')}>
              <span className="subject-icon">💻</span>
              <h4>ICT</h4>
            </div>
          </div>
